...
export const translations = {
  ...
  booking: {
    ...
    title: { ru: "Выберите дату", en: "Choose a Date" },
    subtitle: {
      ru: "Выберите удобную дату для вашего мероприятия — мы покажем форму для заполнения деталей.",
      en: "Select a convenient date for your event — we'll show a form to fill in the details.",
    },
    selected: { ru: "Выбрано", en: "Selected" },
    almostBooked: { ru: "Почти занято", en: "Almost Booked" },
    unavailable: { ru: "Недоступно", en: "Unavailable" },
    bookingTitle: { ru: "Бронирование", en: "Booking" },
    ...
    guestsLabel: { ru: "Гостей", en: "Guests" },
    locationLabel: { ru: "Локация", en: "Location" },
    wishesLabel: { ru: "Пожелания", en: "Wishes" },
    wishesPlaceholder: {
      ru: "Расскажите о стиле, цветах, идеях...",
      en: "Tell us about style, colors, ideas...",
    },
    submitBtn: { ru: "Забронировать", en: "Book Now" },
    submitting: { ru: "Отправка...", en: "Sending..." },
    successMsg: { ru: "Спасибо! Мы свяжемся с вами в течение 24 часов.", en: "Thank you! We'll contact you within 24 hours." },
    errorMsg: { ru: "Ошибка отправки. Попробуйте позже.", en: "Failed to send. Please try again later." },
    eventTypes: [
