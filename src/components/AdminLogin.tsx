...
const AdminLogin = ({ onLogin }: {onLogin: () => void;}) => {
  ...
  return (
    <div className="min-h-screen bg-muted/30 px-4 flex items-center justify-center">
      ...
      <div className="w-full max-w-sm bg-background border border-border p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2 text-lg font-bold">Вход в панель управления</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs uppercase tracking-[0.15em] text-muted-foreground mb-1.5 block font-semibold">Email</label>
          ...
          <div>
            <label className="text-xs uppercase tracking-[0.15em] text-muted-foreground mb-1.5 block font-semibold">Пароль</label>
            <div className="relative">
